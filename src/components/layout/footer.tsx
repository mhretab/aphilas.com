...
const footerLinks = {
  ...
  services: [
    ...
    { label: "Prototype Development", href: "/services#prototype-development" },
  ],
};
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              We transform ideas into innovative digital solutions. From product
              development to IT consultancy, we help businesses thrive in the
              digital age.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} Aphilas Studio AB. All rights reserved.
          </p>
